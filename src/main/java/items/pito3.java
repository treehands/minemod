...
public class pito3 extends Item {
private String name = "pito3";
public pito3() {
...
{
if (obj instanceof entities.EntityCerdo)
{
final entities.EntityCerdo child = (entities.EntityCerdo) obj;
{
