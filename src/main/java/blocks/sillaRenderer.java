...
public class sillaRenderer extends TileEntitySpecialRenderer
{
	private final Modelsilla model = new Modelsilla();
    private static final ResourceLocation texture = new ResourceLocation(Constants.MODID + ":" + "textures/models/diana.png");
    
    public void render(TileEntitySilla te, double x, double y, double z, float scale)
    {
    	GL11.glPushMatrix(); 	
    ...
    {
    	this.render((TileEntitySilla)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}