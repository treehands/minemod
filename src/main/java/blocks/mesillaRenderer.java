...
public class mesillaRenderer extends TileEntitySpecialRenderer
{
	private final Modelmesilla model = new Modelmesilla();
    private static final ResourceLocation texture = new ResourceLocation(Constants.MODID + ":" + "textures/models/diana.png");
    
    public void render(TileEntityMesilla te, double x, double y, double z, float scale)
    {
    	GL11.glPushMatrix(); 	
    ...
    {
    	this.render((TileEntityMesilla)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}